...
\begin{equation}
  ...
  \end{split}
\end{equation}
  for $i = \text{mouse} = 1,...,24$ and $j = \text{neuron} = 1,...,n_i$ (not all mice have the same number of neurons measured).
...
\begin{equation}
  ...
  \end{split}
\end{equation}
for $i = 1,...,24$ and $j = 1,...,n_i$, since $E[u_{i}] = 0$ and $E[\epsilon_{ij}] = 0$ by assumption. 
